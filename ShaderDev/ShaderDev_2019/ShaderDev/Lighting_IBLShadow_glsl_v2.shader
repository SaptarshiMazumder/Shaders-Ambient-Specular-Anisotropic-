...
Shader "ShaderDev/22Lighting_IBLShadow_GLSL_v2"
{
	Properties 
	{
		...
		Pass
		{
			...
			vertexOutput vert(vertexInput v)
			{
				...
				o.posWorld = mul(unity_ObjectToWorld, v.vertex);
					...
					float3 mainTexCol = tex2Dlod(_MainTex, float4(o.texcoord.xy, 0,0));//float3 mainTexCol = tex2D(_MainTex, o.texcoord.xy);
